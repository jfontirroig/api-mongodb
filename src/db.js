...
const CREATE_QUEUE = `CREATE TABLE api (
 apiUserId TEXT NOT NULL
 );`

const CREATE_QUEUE_INDEX = `CREATE INDEX api_index ON
api(apiUserId);`
...
export class RegistrarQueueDB {
    ...
    async addToQueue(apiUserId: string): Promise < void > {
        const dbCmd = 'INSERT INTO api ' +
            '(apiUserId) VALUES (?)'
        const dbArgs = [apiUserId]
